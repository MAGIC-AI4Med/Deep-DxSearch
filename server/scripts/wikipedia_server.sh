...
index_file=/mnt/vision_user/zhengqiaoyu/DiagRL/server/wikipedia/bm25luceneindex
corpus_file=/mnt/vision_user/zhengqiaoyu/DiagRL/server/wikipedia/corpus/wikipedia.jsonl
