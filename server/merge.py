...
if __name__ == "__main__":
    # 设置输入目录和输出文件路径
    input_directory = "/mnt/vision_user/zhengqiaoyu/DiagRL/server/wikipedia/chunk"  # 当前目录
    output_file = "/mnt/vision_user/zhengqiaoyu/DiagRL/server/wikipedia/corpus/wikipedia.jsonl"
