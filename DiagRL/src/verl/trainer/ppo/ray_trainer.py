...
class RayPPOTrainer(object):
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            reward_tensor = self.val_reward_fn(test_batch, os.path.join(self.config.trainer.rollout_save_path, f'val_{self.global_steps}.jsonl'))
    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                # requests.post(f"http://localhost:{self.config.actor_rollout_ref.rollout.server_port}/flush_cache")
                print("Successful clear of KV cache!")
                self.global_steps += 1
